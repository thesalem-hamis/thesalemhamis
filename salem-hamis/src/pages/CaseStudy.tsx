    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        >
          <button
            onClick={() => navigate("/")}
            className="group inline-flex items-center justify-center gap-2.5 bg-black/[0.04] backdrop-blur-2xl border border-black/15 text-black font-medium text-[15px] tracking-[-0.01em] px-6 py-3 rounded-2xl hover:bg-black/[0.08] hover:border-black/25 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-sm"
          >
            <svg
        ...
        >
          <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-black mb-8">
            {project.title}
          </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {project.gallery.map((mediaUrl, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 p-2 shadow-sm min-h-[200px]"
                  >
                    {isVideo ? (
                      <LazyVideo
                        src={mediaUrl}
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <button
              onClick={() => navigate("/")}
              className="group flex items-center justify-center gap-2.5 w-full sm:w-auto bg-black/90 backdrop-blur-md border border-black/20 text-white font-medium text-[15px] tracking-[-0.01em] px-8 py-4 rounded-2xl hover:bg-black transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg"
            >
            ...
            <a
              ...
              className="group flex items-center justify-center gap-2.5 w-full sm:w-auto bg-black/[0.04] backdrop-blur-2xl border border-black/15 text-black font-medium text-[15px] tracking-[-0.01em] px-8 py-4 rounded-2xl hover:bg-black/[0.08] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-sm"
            >
...
// // Helper to reliably resolve static asset URLs across dev and production environments
// const getAssetPath = (path?: string) => {
//   if (!path) return "";
//   if (path.startsWith("http://") || path.startsWith("https://") || path.startsWith("data:")) {
//     return path;
//   }
//   // Remove leading slash if present to safely append
...
//   const heroVideoSrc = getAssetPath(project.heroVideo);
//   const heroImgSrc = getAssetPath(project.heroImage);
...
//         {/* ── Main Hero Media (Reads heroVideo first, falls back to heroImage) ── */}
//         <motion.div
//           variants={fadeUp}
//           initial="hidden"
//           animate="visible"
...
//         {/* ── Gallery Section (Supports both video and image entries) ── */}
//         {project.gallery && project.gallery.length > 0 && (
//           <motion.div
//             variants={fadeUp}
//             initial="hidden"
...
//           >
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//               {project.gallery.map((rawMediaUrl, i) => {
//                 const mediaUrl = getAssetPath(rawMediaUrl);
//                 const isVideo = /\.(mp4|webm|ogg|mov)($|\?)/i.test(mediaUrl);
...
//               <button
//                 onClick={() => navigate("/")}
//                 className="group flex items-center justify-center gap-2.5 w-full sm:w-auto bg-black/90 backdrop-blur-md border border-black/20 text-white font-medium text-[15px] tracking-[-0.01em] px-8 py-4 rounded-2xl hover:bg-black hover:border-black/30 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
//                 style={{ fontFamily: 'var(--font-sans, "Geist", sans-serif)' }}
//               >
//                 <span>All projects</span>
//                 <svg
...
//               <a
//                 href="mailto:thesalemhamis@gmail.com?subject=Let's%20build%20something"
//                 className="group flex items-center justify-center gap-2.5 w-full sm:w-auto bg-black/[0.04] backdrop-blur-2xl border border-black/15 text-black font-medium text-[15px] tracking-[-0.01em] px-8 py-4 rounded-2xl hover:bg-black/[0.08] hover:border-black/25 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-sm"
//                 style={{ fontFamily: 'var(--font-sans, "Geist", sans-serif)' }}
//               >
//                 <span>thesalemhamis@gmail.com</span>
//                 <svg
...
// /* ── Intersection Observer Lazy Loading for Videos ── */
// function LazyVideo({
//   src,
//   poster,
//   className,
