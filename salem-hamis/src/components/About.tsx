    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between gap-12">
          {/* ── Left: all the text ── */}
          <div className="flex-1 min-w-0">
            {/* headline - reduced size and boldness */}
            <h2
              className="font-display leading-[0.93] tracking-[-0.03em] mb-10 max-w-6xl"
              style={{ 
                fontSize: "clamp(2.25rem, 6.5vw, 4.5rem)",
                fontWeight: "600" // Changed from default to medium-bold
              }}
            >
              {lines.map((ln, li) => {
                const globalIdx = lines.slice(0, li).reduce((a, l) => a + l.length, 0);
                      ...
                      {ln.map((w, wi) => (
                        <motion.span
                          ...
                          className={`inline-block ${
                            w.muted ? "text-white/25" : "text-white"
                          }`}
                          style={{ 
                            transformOrigin: "center bottom",
                            fontWeight: "600" // Reduced from black (900) to 600
                          }}
                        >
                          {w.text}
                        </motion.span>
            ...
            {/* sub copy - slightly reduced size */}
            <motion.p
              variants={paragraphGlow}
              initial="hidden"
              animate="visible"
              className="max-w-md text-[14px] md:text-[15px] leading-relaxed"
              style={{
                fontFamily: "'Inter', system-ui, -apple-system, sans-serif",
                color: "rgba(255,255,255,0.55)",
              }}
            ...
            >
              ...
              >
                <a
                  ...
                  className="group flex items-center justify-center gap-2.5
                    bg-white text-black border border-white/20
                    font-medium text-[14px] tracking-[-0.01em]
